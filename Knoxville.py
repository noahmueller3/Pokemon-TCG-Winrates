...
cross_reference = pd.read_csv('Cross-Reference Sheet_Knoxville.csv')
winners_losers = pd.read_csv('Winners and Losers_Knoxville.csv')
...
fig.update_layout(title='Win Rates for Pokemon TCG Matchups at Knoxville Regional',
                  xaxis_title='Deck 2',
                  yaxis_title='Deck 1')
